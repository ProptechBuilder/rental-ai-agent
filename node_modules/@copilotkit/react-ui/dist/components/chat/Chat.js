...
function WrappedCopilotChat({
  ...
  const chatContext = import_react8.default.useContext(ChatContext);
  if (!chatContext) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ChatContextProvider, { icons, labels, open: true, setOpen: () => {
    }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: `copilotKitChat ${className}`, children }) });
  }
